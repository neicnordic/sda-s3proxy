...
func TestUserTokenAuthenticator_ReadFile(t *testing.T) {
	...
	jwtpubkeypath := "login.ega.nbis.se"
	...
	if assert.Nil(err) {
		assert.Equal(a.pubkeys[jwtpubkeypath], []byte{45, 45, 45, 45, 45, 66, 69, 71, 73, 78, 32, 80, 85, 66, 76, 73, 67, 32, 75, 69, 89, 45, 45, 45, 45, 45, 10, 77, 70, 107, 119, 69, 119, 89, 72, 75, 111, 90, 73, 122, 106, 48, 67, 65, 81, 89, 73, 75, 111, 90, 73, 122, 106, 48, 68, 65, 81, 99, 68, 81, 103, 65, 69, 103, 79, 49, 105, 115, 87, 81, 43, 100, 110, 87, 47, 43, 118, 107, 101, 119, 89, 88, 104, 118, 99, 54, 100, 118, 111, 57, 106, 10, 70, 116, 114, 74, 119, 68, 108, 116, 66, 102, 114, 116, 81, 122, 98, 122, 114, 77, 77, 74, 97, 52, 74, 56, 87, 52, 90, 111, 107, 52, 107, 70, 80, 88, 71, 109, 57, 43, 50, 98, 49, 47, 86, 87, 78, 105, 73, 87, 43, 76, 108, 106, 119, 48, 50, 107, 72, 103, 61, 61, 10, 45, 45, 45, 45, 45, 69, 78, 68, 32, 80, 85, 66, 76, 73, 67, 32, 75, 69, 89, 45, 45, 45, 45, 45})
	}
